    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>
            Boutique en ligne d’électroménager et d’ameublement : qualité, prix accessibles et livraison rapide à domicile.
          </p>
          <p>
            Votre destination en ligne pour l’électroménager et l’ameublement à petits prix, alliant confort, style et performance.
          </p>
